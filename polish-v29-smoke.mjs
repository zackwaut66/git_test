...
try{
 ...
 await page.locator('.bottomnav button[data-go="map"]').click();await page.locator('.mapview').waitFor();
 ...
 await page.locator('.bottomnav button[data-go="enclave"]').click();await page.locator('.enclaveview').waitFor();
